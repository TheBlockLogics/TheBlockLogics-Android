...
private class XmlLanguageSpec() :
  TsLanguageSpec(
    TSLanguageXml.getInstance(),
    readFromAsset("editor/treesitter/xml/highlights.scm"),
  )
...
fun TsThemeBuilder.buildXmlTheme() {
  ...
  makeStyle(XML_TAG) applyTo arrayOf("element.tag")
  makeStyle(TEXT_NORMAL) applyTo
    arrayOf("xml_decl", "xmlns.prefix", "attr.prefix", "attr.name", "xml.ref")
